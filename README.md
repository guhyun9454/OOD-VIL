...
## Run RainbowPrompt on VIL with iDigits dataset
```bash
python main.py --dataset iDigits --num_tasks 20 --IL_mode vil --method RainbowPrompt --seed 42 --batch-size 24 --lr 0.005
```
